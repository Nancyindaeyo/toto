...
import { createRabbitMirrorHostCompatibility as createHostCompatibility } from './hostCompatibilityCore.js?rmv=1.5.52-domcompat1';

const COHORT = '1.5.52-domcompat1';
