...
import { isRabbitMirrorManagedChatSurface, getRabbitMirrorMountedMessages } from '../hostCompatibility.js?rmv=1.5.73';
import {
    WORLD_INFO_BOOK_NAME_MAX_CHARS,
    getSettings,
    normalizeIndependentContextExcludedTags,
    updateSettings,
} from '../settings.js?rmv=1.5.73';
...
import { HOST_GENERATION_EVENT_HINT_MS, operationEpochForBase } from './flights.js?rmv=1.5.73';
import {
