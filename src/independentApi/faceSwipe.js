...
import { configuredAutomaticRerollMax } from '../automaticReroll.js?rmv=1.5.60-fork1';
import { seedSwipeState, appendSuccessfulSwipe, readFaceSwipe, mutateFaceSwipe } from '../swipeVersions.js?rmv=1.5.60-fork1';
import { EPHEMERAL_FAILURE_ATTR, EPHEMERAL_FAILURE_BODY_ATTR, RUNTIME_VERSION } from './runtime.js?rmv=1.5.60-split2';
import { independentRecordWithinBudget, readStore, writePersistedOwner, writeStore } from './persistence.js?rmv=1.5.60-split2';
import { saveRecordForSlot, savedIndependentRecordForOwner } from './connection.js?rmv=1.5.60-split2';
import { hasMultifaceMarkup, wrapIndependentFace } from './request.js?rmv=1.5.60-split2';
import { externalFaceDetails, showIndependentUnsavedOutput } from './mount.js?rmv=1.5.60-split2';
