...
import { API_REQUEST_DIAGNOSTIC_EVENT, getLastIndependentApiRequestDiagnostic } from '../independentApi.js?rmv=1.5.74';
import { escapeHtml } from './runtime.js?rmv=1.5.74';
