...
import { WORLD_INFO_BOOKS_CHANGED_EVENT, fetchWorldInfoBooks, getObservedWorldInfoBooks } from '../independentApi.js?rmv=1.5.71';
import { escapeHtml, isCurrentRuntime } from './runtime.js?rmv=1.5.71';
