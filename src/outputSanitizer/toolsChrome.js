...
} from '../theaterFavorites.js?rmv=1.5.69';
import { FACE_SWIPE_FULL_MESSAGE, faceSwipeBarIntent, fallbackFaceSwipeView } from '../swipeVersions.js?rmv=1.5.69';
import {
    FEEDBACK_CAT_TYPES,
...
import { getAvailableHostChat } from './scriptedInteractionRescue.js?rmv=1.5.69';
import { armNestedDetailsReplacementContainment, installNestedDetailsReplacementContainment } from './fallbackRescue.js?rmv=1.5.69';
import { armRabbitMirrorFirstUseInteraction, repairRabbitMirrorScopedClassAliasesInScope } from './idsAndRearm.js?rmv=1.5.69';
import {
...
import { clearOrphanedStructuredStaticDisclosureArtifacts } from './choiceRescue.js?rmv=1.5.69';
import {
...
function installUnifiedMirrorTools(root) {
    ...
    actions.push({ id: 'theater-favorite-library', label: '📖 打开收藏夹', run: () => {
        void import('../independentApi.js?rmv=1.5.69').then(module =>
