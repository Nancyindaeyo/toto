...
import { isRabbitMirrorManagedChatSurface } from '../hostCompatibility.js?rmv=1.5.58-fork1';
...
} from '../theaterFavorites.js?rmv=1.5.70';
import { FACE_SWIPE_FULL_MESSAGE, faceSwipeBarIntent, fallbackFaceSwipeView } from '../swipeVersions.js?rmv=1.5.70';
import {
    FEEDBACK_CAT_TYPES,
...
import { getAvailableHostChat } from './scriptedInteractionRescue.js?rmv=1.5.70';
import { armNestedDetailsReplacementContainment, installNestedDetailsReplacementContainment } from './fallbackRescue.js?rmv=1.5.70';
import { armRabbitMirrorFirstUseInteraction, repairRabbitMirrorScopedClassAliasesInScope } from './idsAndRearm.js?rmv=1.5.70';
import {
...
} from './diagnostics.js?rmv=1.5.70';
import { clearOrphanedStructuredStaticDisclosureArtifacts } from './choiceRescue.js?rmv=1.5.70';
import {
...
function installUnifiedMirrorTools(root) {
    ...
    actions.push({ id: 'theater-favorite-library', label: '📖 打开收藏夹', run: () => {
        void import('../independentApi.js?rmv=1.5.70').then(module =>
