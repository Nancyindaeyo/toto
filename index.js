...
const GOLDEN_MERGE_VERSION = '1.5.69';
const RABBIT_MIRROR_RUNTIME_VERSION = '1.5.69';
...
async function ensureDeferredCoreRuntime(reason = 'scheduled-idle') {
    ...
    deferredRuntimePromise = Promise.all([
        import('./src/outputSanitizer.js?rmv=1.5.69'),
        import('./src/visualScanner.js?rmv=1.5.69'),
        import('./src/independentApi.js?rmv=1.5.69'),
        import('./src/touchTheater.js?rmv=1.5.56-extfloor1'),
        import('./src/ui.js?rmv=1.5.69'),
...
function loadMirrorVisualCompat() {
    ...
    return Promise.all([
        ...
        loadOptional('renderedVisualFeedback', './src/renderedVisualFeedbackHotfix.js?rmv=1.5.69', mod => mod.initRabbitMirrorRenderedVisualFeedbackHotfix?.()),
    ]);
}
